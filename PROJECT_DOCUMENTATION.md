...
2. **Hybrid retrieval earns its complexity on identifier-heavy corpora.** Support content is full of error codes and policy IDs that embeddings blur together and BM25 nails; paraphrased symptoms are the reverse. Fusing both with α=0.6 covered both failure modes; per-category hit@1 is the evidence.
